<?php
define('SITE_NAME','Lilo^Log');				//This defines the site's name.
define('ITEMS_DISPLAYED_PEER_PAGE',10);		//How many posts are to be shown on each page of the index.
define('PREVIEW_SIZE_IN_KB',500);			//How much post previews to provide.
define('DISQUS_SHORTNAME','tslmy');			//disqus_shortname
define('LIST_MODE',0);						//0(default, takes up more CPU):  Renders everything from Markdown everytime they are needed.
